...
// ============================================================================
/**
 * Zod validation schema for all form inputs.
 * Defines requirements for each field type supported by the UI library.
 */
...
// ============================================================================
/**
 * Reactive state object that holds the form values.
 * Initialized with default values where necessary.
 */
...
/**
 * Reference to the UForm component instance for manual control (e.g., clearing).
 */
...
// ============================================================================
/**
 * Standardized options for select, menu, and group components.
 */
const items = [
 ...
 * Displays a toast notification and logs the submitted data.
 */
        ...
        <UForm ref="form" :state="state" :schema="schema" class="w-full" @submit="onSubmit">
            <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <UFormField name="inputMenu" label="InputMenu">
                    <UInputMenu v-model="state.inputMenu" :items="items" placeholder="Search an option..."
                        class="w-full" />
                </UFormField>
                ...
                <UFormField name="inputMenuMultiple" label="InputMenu (Multiple)">
                    <UInputMenu v-model="state.inputMenuMultiple" multiple :items="items"
                        placeholder="Search options..." class="w-full" />
                </UFormField>
                ...
                <UFormField name="selectMultiple" label="Select (Multiple)">
                    <USelect v-model="state.selectMultiple" multiple :items="items" placeholder="Choose options"
                        class="w-full" />
                </UFormField>
                ...
                <UFormField name="selectMenu" label="SelectMenu">
                    <USelectMenu v-model="state.selectMenu" :items="items" placeholder="Search an option..."
                        class="w-full" />
                </UFormField>
