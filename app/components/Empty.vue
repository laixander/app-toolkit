...
<template>
    ...
    <template v-if="loading">
      <div class="relative flex items-center justify-center mb-6">
        ...
        <div class="relative flex items-center justify-center w-16 h-16 rounded-3xl bg-white dark:bg-neutral-900 shadow-sm border border-neutral-200/60 dark:border-neutral-800 ring-8 ring-neutral-50 dark:ring-neutral-950/50">
          <UIcon name="i-lucide-loader-2" class="w-8 h-8 text-primary animate-spin" />
        </div>
      </div>
      <h3 class="text-xl font-bold text-neutral-900 dark:text-white tracking-tight mb-2">
        Loading data...
      </h3>
      <p class="text-sm text-neutral-500 dark:text-neutral-400 max-w-md mx-auto leading-relaxed">
        Please wait while we securely retrieve your records.
      </p>
    </template>
